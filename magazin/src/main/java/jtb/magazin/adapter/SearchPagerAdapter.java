...
//v tomto adapteri store ide ako parameter, cize uz nemusime vytvarat, podobny adapter ako ReadLaterAdapter
public class SearchPagerAdapter extends PagerAdapter {
	...
	public SearchPagerAdapter(Context context,DisplayImageOptions options,ImageLoader imageLoader, SearchArticleStore store) {
    	...
    	//int m=(int) (metrics.widthPixels/Constants.MARGIN_WIDTH_KOEF);
